...
class KidsControllerTest < ActionController::TestCase
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post :create, kid: { birthday: @kid.birthday, hight: @kid.hight, hobby: @kid.hobby, name: @kid.name, weight: @kid.weight }
    end
  ...
  test "should update kid" do
    patch :update, id: @kid, kid: { birthday: @kid.birthday, hight: @kid.hight, hobby: @kid.hobby, name: @kid.name, weight: @kid.weight }
    assert_redirected_to kid_path(assigns(:kid))
  end
